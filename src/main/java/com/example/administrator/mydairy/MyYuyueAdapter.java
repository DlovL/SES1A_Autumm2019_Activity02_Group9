...
public class MyYuyueAdapter extends BaseAdapter {
    ...
    public MyYuyueAdapter(Context context, List<Charity> list){
        mList = list;
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        viewHolder.textView.setText(mList.get(count).getName());
        viewHolder.textView1.setText(mList.get(count).getDate());
        return view;
    }
